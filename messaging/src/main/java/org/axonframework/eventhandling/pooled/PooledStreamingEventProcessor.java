...
public class PooledStreamingEventProcessor extends AbstractEventProcessor implements StreamingEventProcessor, Lifecycle {
    ...
    protected PooledStreamingEventProcessor(PooledStreamingEventProcessor.Builder builder) {
        ...
        this.coordinator = Coordinator.builder()
                                      ...
                                      .clock(clock)
                                      .maxSegmentProvider(this.maxSegmentProvider)
     ...
     * required, this value can be adjusted through the {@link Builder#maxSegmentProvider(MaxSegmentProvider)} method.
     */
    @Override
    public int maxCapacity() {
        return maxSegmentProvider.accept(name);
    }
    ...
    public static class Builder extends AbstractEventProcessor.Builder {
        ...
        public Builder maxSegmentProvider(MaxSegmentProvider maxSegmentProvider) {
            assertStrictPositive(maxSegmentProvider.accept(name), "Max claimed segments should be a higher valuer than zero");
